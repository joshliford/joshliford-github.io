...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <Card className="w-full max-w-2xl border border-slate-700 bg-slate-700 hover:bg-slate-600 mb-16 transition-all duration-300 hover:-translate-y-1 hover:border hover:border-orange-400">
